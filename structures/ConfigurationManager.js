...
module.exports = class ConfigurationManager {
    ...
    constructor(module, defaultConfig, name = 'config') {
        ...
        if (!fs.existsSync(this.path)) {
            if(module.logger)
                this.module.constructor.name ? module.logger.info(`Creating ${this.name}.yml file for ${this.module.constructor.name}`) : console.log(`Creating ${this.name}.yml file for Client`)
